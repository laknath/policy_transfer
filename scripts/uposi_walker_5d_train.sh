...
# 0-7: mass, 7-12: damping, 13: friction, 14: cor, 15: power, 16: ankle power, 17: frame_skip_range, 18: up_noise_range
mpirun --map-by socket:OVERSUBSCRIBE -np 6 python policy_transfer/ppo/run_ppo.py --env $ENV_NAME \
					...
					--dyn_params 0 --dyn_params 1 --dyn_params 2 --dyn_params 13 --dyn_params 14 \
					--name walker5d
